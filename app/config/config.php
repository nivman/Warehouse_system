...
|
*/
$config['base_url'] = 'http://localhost/RC3.0.2.24/';
...
|
*/
$config['encryption_key'] = 'tvNUDRydxAGscIkFBq6gew17TY3HL8CmMzKnh';
...
if (isset($_SERVER["REQUEST_URI"]))
{
    ...
    if(stripos($_SERVER["REQUEST_URI"],'/mypage') === 1)
    {
...
$config['csrf_exclude_uris'] = array('welcome/image_upload');
