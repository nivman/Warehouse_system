 ...
 */
$config['site_title']                 = "Warehouse_system";       // Site Title, example.com This is not more functional
$config['admin_email']                = "stock@nimadomain.com"; // Admin Email, admin@example.com This is not more functional
