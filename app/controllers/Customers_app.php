...
class Customers_app extends MY_Controller
{
...
//        }
    ...
    function customer_details($company_data, $id = NULL)
    {
       // $this->sma->checkPermissions(false, true);
...
//        }
    ...
    function edit_customer_details($id = NULL)
    {
        // $this->sma->checkPermissions(false, true);
        $data= json_decode(file_get_contents("php://input"));
        ...
        $customerField1 = $data->customerField1;
        $customerField2 = $data->customerField2;
        $customerField3 = $data->customerField3;
        $customerField4 = $data->customerField4;
        $customerField5 = $data->customerField5;
        $customerField6 = $data->customerField6;
...
//        }
        ...
        $customer_data = array('name' =>$customerName,
            ...
            'price_group_name' => $customerPriceGroup,
...
//        $company_data->customer_groups = $this->data['customer_groups'];
//        $company_data->price_groups = $this->data['price_groups'];
       $this->companies_model->updateCompany($id, $customer_data);
            ...
            if (!empty($_POST['val'])) {
                ...
                if ($this->input->post('form_action') == 'export_excel' || $this->input->post('form_action') == 'export_pdf') {
                    ...
                    if($this->Settings->user_language=="hebrew" &&  $this->input->post('form_action') == 'export_pdf'){
                        ...
                        $this->excel->getActiveSheet()->SetCellValue('P1', lang('name'));
                        $this->excel->getActiveSheet()->SetCellValue('O1', lang('email'));
                        $this->excel->getActiveSheet()->SetCellValue('N1', lang('phone'));
                        $this->excel->getActiveSheet()->SetCellValue('M1', lang('address'));
                        $this->excel->getActiveSheet()->SetCellValue('L1', lang('city'));
                        ...
                        $this->excel->getActiveSheet()->SetCellValue('G1', lang('deposit_amount'));
                        $this->excel->getActiveSheet()->SetCellValue('F1', lang('ccf1'));
                        $this->excel->getActiveSheet()->SetCellValue('E1', lang('ccf2'));
                        $this->excel->getActiveSheet()->SetCellValue('D1', lang('ccf3'));
                        $this->excel->getActiveSheet()->SetCellValue('C1', lang('ccf4'));
                        $this->excel->getActiveSheet()->SetCellValue('B1', lang('ccf5'));
                        $this->excel->getActiveSheet()->SetCellValue('A1', lang('ccf6'));
                    }else{
                    ...
                    foreach ($_POST['val'] as $id) {
                        if($this->Settings->user_language=="hebrew" &&  $this->input->post('form_action') == 'export_pdf'){
                            ...
                            $this->excel->getActiveSheet()->SetCellValue('Q' . $row, $customer->company);
                            $this->excel->getActiveSheet()->SetCellValue('P' . $row, $customer->name);
                            $this->excel->getActiveSheet()->SetCellValue('O' . $row, $customer->email);
                            $this->excel->getActiveSheet()->SetCellValue('N' . $row, $customer->phone);
                            $this->excel->getActiveSheet()->SetCellValue('M' . $row, $customer->address);
                            $this->excel->getActiveSheet()->SetCellValue('L' . $row, $customer->city);
                            $this->excel->getActiveSheet()->SetCellValue('K' . $row, $customer->state);
                            $this->excel->getActiveSheet()->SetCellValue('J' . $row, $customer->postal_code);
                            ...
                            $this->excel->getActiveSheet()->SetCellValue('G' . $row, $customer->deposit_amount);
