...
class Sales_app extends MY_Controller
{
...
//        }
    ...
    public function pdf($id = null, $view = null, $save_bufffer = null)
    {
        ...
        if($this->Settings->user_language=="hebrew"){
            $html = $this->load->view($this->theme . 'sales/pdf_rtl', $this->data, true);
        }else{
        ...
        if ($view) {
            if($this->Settings->user_language=="hebrew"){
                $html_data = $this->load->view($this->theme . 'sales/pdf_rtl', $this->data, true);
            }else{
            ...
            if (!empty($_POST['val'])) {
                if ($this->input->post('form_action') == 'delete') {
                    ...
                    if($this->Settings->user_language=="hebrew" &&  $this->input->post('form_action') == 'export_pdf'){
                        ...
                        $this->excel->getActiveSheet()->SetCellValue('C1', lang('grand_total'));
                    ...
                    foreach ($_POST['val'] as $id) {
                        if($this->Settings->user_language=="hebrew" &&  $this->input->post('form_action') == 'export_pdf'){
                            $sale = $this->sales_model->getInvoiceByID($id);
                            $this->excel->getActiveSheet()->SetCellValue('G' . $row, $this->sma->hrld($sale->date));
                            ...
                            $this->excel->getActiveSheet()->SetCellValue('B' . $row, lang($sale->paid));
                            $this->excel->getActiveSheet()->SetCellValue('A' . $row, lang($sale->payment_status));
                        }else{
                            $sale = $this->sales_model->getInvoiceByID($id);
            ...
            if (!empty($_POST['val'])) {
                ...
                if ($this->input->post('form_action') == 'export_excel' || $this->input->post('form_action') == 'export_pdf') {
                    ...
                    if($this->Settings->user_language=="hebrew" &&  $this->input->post('form_action') == 'export_pdf'){
                        ...
                        $this->excel->getActiveSheet()->SetCellValue('E1', lang('do_reference_no'));
                    ...
                    foreach ($_POST['val'] as $id) {
                        if($this->Settings->user_language=="hebrew" &&  $this->input->post('form_action') == 'export_pdf'){
                            ...
                            $this->excel->getActiveSheet()->SetCellValue('F' . $row,'   '. $this->sma->hrld($delivery->date).'   ');
                            $this->excel->getActiveSheet()->SetCellValue('E' . $row, $delivery->do_reference_no);
                            $this->excel->getActiveSheet()->SetCellValue('D' . $row, $delivery->sale_reference_no);
                            $this->excel->getActiveSheet()->SetCellValue('C' . $row, $delivery->customer);
                            $this->excel->getActiveSheet()->SetCellValue('B' . $row, $delivery->address);
                            $this->excel->getActiveSheet()->SetCellValue('A' . $row, lang($delivery->status));
                        }else{
                            $delivery = $this->sales_model->getDeliveryByID($id);
            ...
            if (!empty($_POST['val'])) {
                ...
                if ($this->input->post('form_action') == 'export_excel' || $this->input->post('form_action') == 'export_pdf') {
                    ...
                    if($this->Settings->user_language=="hebrew" &&  $this->input->post('form_action') == 'export_pdf'){
                        ...
                        $this->excel->getActiveSheet()->SetCellValue('C1', lang('card_no'));
                    ...
                    foreach ($_POST['val'] as $id) {
                        if($this->Settings->user_language=="hebrew" &&  $this->input->post('form_action') == 'export_pdf'){
                            ...
                            $this->excel->getActiveSheet()->SetCellValue('C' . $row, $sc->card_no);
                            $this->excel->getActiveSheet()->SetCellValue('B' . $row, $sc->value);
                            $this->excel->getActiveSheet()->SetCellValue('A' . $row, $sc->customer);
                        }else{
                            $sc = $this->site->getGiftCardByID($id);
