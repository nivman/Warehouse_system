...
class Suppliers_app extends MY_Controller
{
...
//        }
    ...
    function suppliers_details($suppliers_data,$id = NULL)
    {
        //$this->sma->checkPermissions(false, true);
...
//            redirect($_SERVER["HTTP_REFERER"]);
        ...
        //}
        $suppliers_data = new stdClass();
        $suppliers_data->supplier=$this->data['supplier'];

        echo json_encode($suppliers_data);
    }
    function edit_supplier_details($id = NULL)
    {
        // $this->sma->checkPermissions(false, true);
        $data= json_decode(file_get_contents("php://input"));
        ...
        $supplierField1 = $data->supplierField1;
        $supplierField2 = $data->supplierField2;
        $supplierField3 = $data->supplierField3;
        $supplierField4 = $data->supplierField4;
        $supplierField5 = $data->supplierField5;
        $supplierField6 = $data->supplierField6;
...
//        }
        ...
        $supplier_data = array('name' =>$supplierName,
...
//        $company_data->customer=$this->data['customer'];
//        $company_data->customer_groups = $this->data['customer_groups'];
//        $company_data->price_groups = $this->data['price_groups'];
        $this->companies_model->updateCompany($id, $supplier_data);
            ...
            if (!empty($_POST['val'])) {
                ...
                if ($this->input->post('form_action') == 'export_excel' || $this->input->post('form_action') == 'export_pdf') {
                    ...
                    if($this->Settings->user_language=="hebrew" &&  $this->input->post('form_action') == 'export_pdf'){
                        $this->excel->getActiveSheet()->SetCellValue('P1', lang('company'));
                        $this->excel->getActiveSheet()->SetCellValue('O1', lang('name'));
                        $this->excel->getActiveSheet()->SetCellValue('N1', lang('email'));
                        $this->excel->getActiveSheet()->SetCellValue('M1', lang('phone'));
                        $this->excel->getActiveSheet()->SetCellValue('L1', lang('address'));
                        $this->excel->getActiveSheet()->SetCellValue('K1', lang('city'));
                        ...
                        $this->excel->getActiveSheet()->SetCellValue('F1', lang('scf1'));
                        $this->excel->getActiveSheet()->SetCellValue('E1', lang('scf2'));
                        $this->excel->getActiveSheet()->SetCellValue('D1', lang('scf3'));
                        $this->excel->getActiveSheet()->SetCellValue('C1', lang('scf4'));
                        $this->excel->getActiveSheet()->SetCellValue('B1', lang('scf5'));
                        $this->excel->getActiveSheet()->SetCellValue('A1', lang('scf6'));
                    ...
                    foreach ($_POST['val'] as $id) {
                        if($this->Settings->user_language=="hebrew" &&  $this->input->post('form_action') == 'export_pdf'){
                            ...
                            $this->excel->getActiveSheet()->SetCellValue('P' . $row, $customer->company);
                            $this->excel->getActiveSheet()->SetCellValue('O' . $row, $customer->name);
                            $this->excel->getActiveSheet()->SetCellValue('N' . $row, $customer->email);
                            $this->excel->getActiveSheet()->SetCellValue('M' . $row, $customer->phone);
                            $this->excel->getActiveSheet()->SetCellValue('L' . $row, $customer->address);
                            $this->excel->getActiveSheet()->SetCellValue('K' . $row, $customer->city);
                            ...
                            $this->excel->getActiveSheet()->SetCellValue('F' . $row, $customer->cf1);
                            $this->excel->getActiveSheet()->SetCellValue('E' . $row, $customer->cf2);
                            $this->excel->getActiveSheet()->SetCellValue('D' . $row, $customer->cf3);
                            $this->excel->getActiveSheet()->SetCellValue('C' . $row, $customer->cf4);
                            $this->excel->getActiveSheet()->SetCellValue('B' . $row, $customer->cf5);
                            $this->excel->getActiveSheet()->SetCellValue('A' . $row, $customer->cf6);
                        }else{
                            $customer = $this->site->getCompanyByID($id);
