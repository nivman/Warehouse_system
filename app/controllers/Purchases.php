    ...
    public function combine_pdf($purchases_id)
    {
        ...
        foreach ($purchases_id as $purchase_id) {
            ...
            if($this->Settings->user_language=="hebrew"){
                $inv_html = $this->load->view($this->theme . 'purchases/pdf_rtl', $this->data, true);
            }else{
                    ...
                    if ($row->type == 'combo') {
                      ...
                      //      $options = $this->purchases_model->getProductOptions($crow->id);
                           ...
                           // $pr[$ri] = array('id' => $c, 'item_id' => $crow->id, 'label' => $crow->name . " (" . $crow->code . ")", 'row' => $crow, 'tax_rate' => $tax_rate, 'units' => $units, 'options' => $options);
                            $pr[$ri] = array('id' => $c, 'item_id' => $crow->id, 'label' => $crow->name . " (" . $crow->code . ")", 'row' => $crow, 'tax_rate' => $tax_rate, 'units' => $units);
                            $c++;
                        }
            ...
            if (!empty($_POST['val'])) {
                if ($this->input->post('form_action') == 'delete') {
                    ...
                    if($this->Settings->user_language=="hebrew" &&  $this->input->post('form_action') == 'export_pdf'){
                        ...
                        $this->excel->getActiveSheet()->SetCellValue('A1', lang('grand_total'));
                    }else{
                    ...
                    foreach ($_POST['val'] as $id) {
                        if($this->Settings->user_language=="hebrew" &&  $this->input->post('form_action') == 'export_pdf'){
                            ...
                            $this->excel->getActiveSheet()->SetCellValue('E' . $row, $this->sma->hrld($purchase->date));
                            ...
                            $this->excel->getActiveSheet()->SetCellValue('B' . $row, $purchase->status);
                            $this->excel->getActiveSheet()->SetCellValue('A' . $row, $this->sma->formatMoney($purchase->grand_total));
                        }else{
                            $purchase = $this->purchases_model->getPurchaseByID($id);
                ...
                if ($this->input->post('form_action') == 'export_excel' || $this->input->post('form_action') == 'export_pdf') {
                    ...
                    foreach ($_POST['val'] as $id) {
                        if($this->Settings->user_language=="hebrew" &&  $this->input->post('form_action') == 'export_pdf'){
                            ...
                            $this->excel->getActiveSheet()->SetCellValue('E' . $row, $this->sma->hrld($expense->date));
                            $this->excel->getActiveSheet()->SetCellValue('D' . $row, $expense->reference);
                            $this->excel->getActiveSheet()->SetCellValue('C' . $row, $this->sma->formatMoney($expense->amount));
                            $this->excel->getActiveSheet()->SetCellValue('B' . $row, $this->sma->decode_html($expense->note));
                            ...
                            $this->excel->getActiveSheet()->SetCellValue('C' . $row, $this->sma->formatMoney($expense->amount));
                            $this->excel->getActiveSheet()->SetCellValue('D' . $row, $this->sma->decode_html($expense->note));
