...
class Transfers_app extends MY_Controller
{
...
//        }
    ...
    function modal_view($transfer_id = NULL)
    {
    ...
    public function combine_pdf($transfers_id)
    {
        ...
        foreach ($transfers_id as $transfer_id) {
            ...
            if($this->Settings->user_language=="hebrew"){
                $html_data = $this->load->view($this->theme . 'transfers/pdf_rtl', $this->data, TRUE);
            }else{
                $html_data = $this->load->view($this->theme . 'transfers/pdf', $this->data, TRUE);
            }
            $html[] = array(
                'content' => $html_data,
                'footer' => '',
            ...
            if (!empty($_POST['val'])) {
                if ($this->input->post('form_action') == 'delete') {
                    ...
                    if($this->Settings->user_language=="hebrew" &&  $this->input->post('form_action') == 'export_pdf'){
                        ...
                        $this->excel->getActiveSheet()->SetCellValue('D1', lang('from_warehouse'));
                        $this->excel->getActiveSheet()->SetCellValue('C1', lang('to_warehouse'));
                    ...
                    foreach ($_POST['val'] as $id) {
                        if($this->Settings->user_language=="hebrew" &&  $this->input->post('form_action') == 'export_pdf'){
                            ...
                            $this->excel->getActiveSheet()->SetCellValue('F' . $row, $this->sma->hrld($tansfer->date));
                            $this->excel->getActiveSheet()->SetCellValue('E' . $row, $tansfer->transfer_no);
                            $this->excel->getActiveSheet()->SetCellValue('D' . $row, $tansfer->from_warehouse_code." ".$tansfer->from_warehouse_name);
                            $this->excel->getActiveSheet()->SetCellValue('C' . $row, $tansfer->to_warehouse_code." ".$tansfer->to_warehouse_name);
                            $this->excel->getActiveSheet()->SetCellValue('B' . $row, $tansfer->grand_total);
                            $this->excel->getActiveSheet()->SetCellValue('A' . $row, $tansfer->status);
                            ...
                            $this->excel->getActiveSheet()->SetCellValue('C' . $row, $tansfer->from_warehouse_code." ".$tansfer->from_warehouse_name);
                            $this->excel->getActiveSheet()->SetCellValue('D' . $row, $tansfer->to_warehouse_code." ".$tansfer->to_warehouse_name);
