...
(function() {
    ...
    var v, D = document,
        ...
        Gb = O.opera,
        ya = /(msie|trident)/i.test(Ba) && !Gb,
        hb = D.documentMode === 8,
        xb = /AppleWebKit/.test(Ba),
        La = /Firefox/.test(Ba),
        Hb = /(Mobile|Android|Windows Phone)/.test(Ba),
        Ca =
        "http://www.w3.org/2000/svg",
        ba = !!D.createElementNS && !!D.createElementNS(Ca, "svg").createSVGRect,
        Lb = La && parseInt(Ba.split("Firefox/")[1], 10) < 4,
        ea = !ba && !ya && !!D.createElement("canvas").getContext,
        $a, ab, Ib = {},
        yb = 0,
        fb, S, Oa, za, zb, F, ma = function() {
            return v
        },
        X = [],
        bb = 0,
        ...
        Nb = "stroke-width",
        Aa, gb, nb, eb, rb, sb, tb, Xa, Ya, Za, Db, Eb, ub, vb, wb, N = {},
        y;
    y = O.Highcharts = O.Highcharts ? ka(16, !0) : {};
    y.seriesTypes = N;
    var q = y.extend = function(a,
            b) {
            var c;
            a || (a = {});
            for (c in b) a[c] = b[c];
    ...
    S = {
        ...
        tooltip: {
            ...
            pointFormat: '<b>{point.y} <b>:{series.name}<span style="color:{point.color}"> ● </span></b><br/>',
            shadow: !0,
            snap: Hb ? 25 : 10,
            style: {
                color: "#333333",
    ...
    L.prototype = {
        ...
        colorGradient: function(a, b, c) {
            ...
            if (f) {
                ...
                f === "radialGradient" && n && !r(g.gradientUnits) && (g = z(g, {
        ...
        applyTextShadow: function(a) {
            var b =
                ...
                e = this.renderer.forExport || b.style.textShadow !== v && !ya;
    ...
    L.prototype["stroke-widthSetter"] = L.prototype.strokeSetter = function(a, b, c) {
        this[b] = a;
        if (this.stroke &&
            this["stroke-width"]) this.strokeWidth = this["stroke-width"], L.prototype.fillSetter.call(this, this.stroke, "stroke", c), c.setAttribute("stroke-width", this["stroke-width"]), this.hasStroke = !0;
    ...
    ta.prototype = {
        ...
        buildText: function(a) {
            ...
            !f && !o && !s && e.indexOf(" ") === -1 ? b.appendChild(D.createTextNode(u(e))) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, T && T.appendChild(b), e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g) : [e], e[e.length - 1] === "" && e.pop(), m(e, function(e, f) {
                var g, n = 0,
                ...
                m(g, function(e) {
                    if (e !== "" || g.length === 1) {
                        ...
                        if (e !== " ") {
                            ...
                            if (l) {
                                for (var o = e.replace(/([^\^])-/g, "$1- ").split(" "), m = g.length > 1 || f || o.length > 1 && k.whiteSpace !== "nowrap", T, r, ua, v = [], t = B(x), w = 1, q = a.rotation, z = e, y = z.length;
                                    (m || s) && (o.length || v.length);) a.rotation = 0, T = a.getBBox(!0), ua = T.width, !ba && c.forExport && (ua = c.measureSpanWidth(x.firstChild.data, a.styles)), T = ua > l, r === void 0 && (r = T), s && r ? (y /= 2, z === "" || !T && y < 0.5 ? o = [] : (T && (r = !0), z = e.substring(0, z.length +
                                    (T ? -1 : 1) * sa(y)), o = [z + "…"], x.removeChild(x.firstChild))) : !T || o.length === 1 ? (o = v, v = [], o.length && (w++, x = D.createElementNS(Ca, "tspan"), I(x, {
                                    dy: t,
                                    x: j
                                }), p && I(x, "style", p), b.appendChild(x)), ua > l && (l = ua)) : (x.removeChild(x.firstChild), v.unshift(o.pop())), o.length && x.appendChild(D.createTextNode(o.join(" ").replace(/- /g, "-")));
    ...
    q(L.prototype, {
            ...
            if (this.added) {
                ...
                if (b.tagName === "SPAN") {
                    ...
                    if (o !== this.cTT) {
                        ...
                        if (i > n && /[ \-]/.test(b.textContent || b.innerText)) J(b, {
                            width: n + "px",
                            display: "block",
        ...
        setSpanRotation: function(a, b, c) {
            var d = {},
                e = ya ? "-ms-transform" : xb ? "-webkit-transform" : La ? "MozTransform" : Gb ? "-o-transform" : "";
    ...
    if (!ba && !ea) {
        A = {
            ...
            fillSetter: function(a, b, c) {
                ...
                else if (d !== "IMG") c.filled = a !== M, this.setAttr("fillcolor", this.renderer.color(a, c, b, this))
            },
            opacitySetter: ma,
        ...
        var Na = {
            ...
            color: function(a, b, c, d) {
                ...
                if (i) {
                    ...
                    if (c === "fill")
                        if (i === "gradient") c = n.x1 || n[0] || 0, a = n.y1 || n[1] || 0, o = n.x2 || n[2] || 0, n = n.y2 || n[3] || 0, u = 'angle="' + (90 - V.atan((n - a) / (o - c)) * 180 / la) + '"', t();
                        else {
                            var j = n.r,
                                v = j * 2,
                                w = j * 2,
    ...
    Ta.prototype = {
        addLabel: function() {
            ...
            r(d) ? d && d.attr({
                text: b
            }) : (this.labelLength = (this.label = d = r(b) && g.enabled ? c.renderer.text(b, 0, 0, g.useHTML).css(z(g.style)).add(a.labelGroup) :
        ...
        handleOverflow: function(a) {
            var b = this.axis,
                ...
                b = b.slotWidth,
                k;
            if (h) h < 0 && c - i * j < f ? k = w(c / W(h * ga) - f) : h > 0 && c + i * j > e && (k = w((d - c) / W(h * ga)));
            else {
                d = c - i * j;
                c += i * j;
        ...
        render: function(a, b, c) {
            var d = this.axis,
                ...
                t = !0,
                w = d.tickmarkOffset,
                q = this.getPosition(g, j, w, b),
                y = q.x,
                q = q.y,
                z = g && y === d.pos + d.len || !g && q === d.pos ? -1 : 1,
                c = p(c, 1);
            this.isActive = !0;
            if (s) {
            ...
            if (n && B) r === "inside" && (B = -B), d.opposite && (B = -B), h = this.getMarkPath(y, q, B, n * z, g, f), o ? o.animate({
                d: h,
                opacity: c
    ...
    y.PlotLineOrBand.prototype = {
        render: function() {
            ...
            else if (o && o.length && (a.svgElem = n = t.path(o).attr(u).add(), m))
                for (s in d = function(b) {
                        n.on(b, function(c) {
                            m[b].apply(a, [c])
                        })
                    }, m) d(s);
    ...
    va.prototype = {
        ...
        defaultLabelFormatter: function() {
            ...
            if (h) g = Ja(h, this);
                ...
                for (; f-- && g === v;) c = Math.pow(1E3, f + 1), a >= c && e[f] !== null && (g = y.numberFormat(b / c, -1) + e[f]);
            ...
            if (this.autoRotation) m(c, function(a) {
                ...
                for (h = c.length; !f && h--;)
                    if (i = c[h], (i = d[i].label) &&
                        this.len / c.length - 4 < i.getBBox().height) i.specCss = {
                        textOverflow: "ellipsis"
                    }
            }
            j.rotation && (k = {
        ...
        render: function() {
            var a = this,
                ...
                o = a.tickmarkOffset,
                s = d.lineWidth,
                x, p = b.hasRendered && r(a.oldMin) && !isNaN(a.oldMin);
            x = a.hasData;
            var B = a.showAxis,
                u, q;
        ...
        drawCrosshair: function(a, b) {
            ...
            else if (p(d.snap, !0) ? r(b) && (c = this.isXAxis ? b.plotX : this.len - b.plotY) : c = this.horiz ? a.chartX -
                this.pos : this.len - a.chartY + this.pos, c = this.isRadial ? this.getPlotLinePath(this.isXAxis ? b.x : p(b.stackY, b.y)) || null : this.getPlotLinePath(null, null, null, null, c) || null, c === null) this.hideCrosshair();
    ...
    q(va.prototype, {
        ...
        addPlotBandOrLine: function(a, b) {
            var c = (new y.PlotLineOrBand(this, a)).render(),
                d = this.userOptions;
    ...
    Va.prototype = {
        ...
        runPointActions: function(a) {
            ...
            if (n && (n !== g || d && d.isHidden)) {
                ...
                (f = d.getAnchor([{}], a), d.updatePosition({
                    plotX: f[0],
                    plotY: f[1]
                }));
            ...
            if (this.selectionMarker) {
                ...
                if (this.hasDragged || d) m(c.axes, function(c) {
                    if (c.zoomEnabled && r(c.min) && (d || b[{
                        ...
                        var f = c.horiz,
                            o = a.type === "touchend" ? c.minPixelPadding :
                            0,
                            s = c.toValue((f ? g : h) + o),
    ...
    mb.prototype = {
        ...
        scroll: function(a, b) {
            var c = this.pages,
                ...
                j = this.padding;
            e > d && (e = d);
            if (e > 0) b !== v && Sa(b, this.chart), this.nav.attr({
                translateX: j,
    ...
    A.prototype = {
        ...
        cloneRenderTo: function(a) {
            ...
            a ? b && (this.renderTo.appendChild(c), Ra(b), delete this.renderToClone) : (c &&
                c.parentNode === this.renderTo && this.renderTo.removeChild(c), this.renderToClone = b = this.renderTo.cloneNode(0), J(b, {
                    position: "absolute",
                    top: "-9999px",
                    display: "block"
        ...
        setChartSize: function(a) {
            ...
            this.clipBox = {
                ...
                height: t(0, U(this.plotSizeY - t(d, h[2]) /
                    2 - c))
            };
        ...
        drawChartBox: function() {
            ...
            if (k) f ? f.animate(u) : this.plotBackground = b.rect(s, p, m, r, 0).attr({
                fill: k
    ...
    R.prototype = {
            ...
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData && e.visible) m(a, function(a, b) {
                ...
                if (o && h > o) {
                    ...
                    if (qa(k)) {
                        ...
                        if (r)
                            for (c = 0; c < h; c++) i = a[c], s[c] = i[0], x[c] = i.slice(1, r + 1);
                        else
                            for (c = 0; c < h; c++) i = a[c], s[c] = i[0], x[c] = i[1];
                    else ka(12)
                } else
                    for (c = 0; c < h; c++)
                        if (a[c] !== v && (i = {
                                series: e
                            }, e.pointClass.prototype.applyOptions.apply(i, [a[c]]), e.updateParallelArrays(i, c), n && i.name)) l.names[i.x] =
                            i.name;
                Da(x[0]) && ka(14, !0);
                e.data = [];
                e.options.data = a;
        ...
        generatePoints: function() {
            ...
            if (b && (g !== (c = b.length) || j))
                for (n =
                    0; n < c; n++)
                    if (n === h && !j && (n += g), b[n]) b[n].destroyElements(), b[n].plotX = v;
            this.data = b;
            this.points = l
        },
        getExtremes: function(a) {
            ...
            d = a.length;
            for (l = 0; l < d; l++)
                if (j = c[l], k = a[l], i = k !== null && k !== v && (!b.isLog || k.length || k > 0), j = this.getExtremesFromAll || this.cropped || (c[l + 1] || j) >= g && (c[l - 1] || j) <= h, i && j)
                    if (i = k.length)
        ...
        drawPoints: function() {
            var a, b = this.points,
                ...
                n = this.pointAttr[""],
                o, m, x, r = this.markerGroup,
                t = p(l.enabled, this.xAxis.isRadial, this.closestPointRangePx > 2 * l.radius);
            if (l.enabled !== !1 || this._hasPointMarkers)
                for (f = b.length; f--;)
                    if (g = b[f], d = U(g.plotX), e = g.plotY, k = g.graphic, o = g.marker || {}, m = !!g.marker, a = t && o.enabled === v || o.enabled, x = g.isInside, a && e !== v && !isNaN(e) && g.y !== null)
                        if (a = g.pointAttr[g.selected ? "select" : ""] || n, h = a.r, i = p(o.symbol,
                                this.symbol), j = i.indexOf("url") === 0, k) k[x ? "show" : "hide"](!0).animate(q({
                            x: d - h,
                            y: e - h
                        }, k.symbolName ? {
                            width: 2 * h,
    ...
    xa = ja(R, {
        ...
        getPointSpline: function(a, b, c) {
            ...
            c ? (b = ["C", f.rightContX ||
                f.plotX, f.rightContY || f.plotY, h || d, i || e, d, e
    ...
    xa = ja(R, {
        ...
        drawPoints: function() {
            ...
            m(a.points, function(h) {
                var i = h.plotY,
                    j = h.graphic;
                if (i !== v && !isNaN(i) && h.y !== null) f = h.shapeArgs, i = r(a.borderWidth) ? {
    ...
    Q = {
        ...
        drawPoints: function() {
            var a = this,
                ...
                f, g;
            if (e &&
                !a.shadowGroup) a.shadowGroup = b.g("shadow").add(a.group);
            m(a.points, function(h) {
                d = h.graphic;
                g = h.shapeArgs;
                f = h.shadowGroup;
        ...
        if (a.visible && (e.enabled || a._hasPointLabels)) {
                    ...
                    if (n > 0) {
                        ...
                        for (E = 0; E < M; E++) {
                            ...
                            if (L < E && K[E] !== null) L = E;
                                ...
                                for (u < M - E + L && K[E] !== null && (L = u - M + E); K[L] === null;) L++;
                            O.push({
                                i: L,
                                y: K[L]
                            });
            ...
            if (Fa(G) === 0 || this.verifyDataLabelOverflow(G)) this.placeDataLabels(), v && g && m(this.points, function(b) {
                ...
                if ((y = b.dataLabel) && y._pos) F =
                    y._attr.visibility, C = y.connX, A = y.connY, k = l ? ["M", C + (z[6] === "left" ? 5 : -5), A, "C", C, A, 2 * z[2] - z[4], 2 * z[3] - z[5], z[2], z[3], "L", z[4], z[5]] : ["M", C + (z[6] === "left" ? 5 : -5), A, "L", z[2], z[3], "L", z[4], z[5]], j ? (j.animate({
                        d: k
    ...
    q(R.prototype, {
        ...
        setVisible: function(a, b) {
            ...
            m(["group",
                "dataLabelsGroup", "markerGroup", "tracker"
            ], function(a) {
                if (c[a]) c[a][f]()
            });
