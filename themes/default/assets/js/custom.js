...
! function(e) {
    var i = '{preview}\n<div class="input-group {class}">\n   {caption}\n   <div class="input-group-btn">\n       {remove}\n       {upload}\n       {browse}\n   </div>\n</div>',
        ...
        d = function(i, t, n) {
            return p(i) || p(i[t]) ? n : e(i[t])
        },
        m = function(e, i) {
            return "undefined" != typeof e ? e.match("image.*") : i.match(/\.(gif|png|jpe?g)$/i)
        },
        v = function(e, i) {
            return "undefined" != typeof e ? e.match("text.*") : i.match(/\.(txt|md|csv|htm|html|php|ini)$/i)
        },
        u = function() {
        ...
        g = function(i, t) {
            this.$element = e(i), f() ? (this.init(t), this.listen()) : this.$element.removeClass("file-loading")
        };
    g.prototype = {
        constructor: g,
        init: function(e) {
            ...
            n.initialPreviewCount = c(a) ? a.length : a.length > 0 ? a.split(n.initialDelimiter).length : 0, n.initPreview(), n.original = {
                preview: n.$preview.html(),
                caption: n.$caption.html()
            }, n.options = e, n.$element.removeClass("file-loading")
        },
        listen: function() {
            var i = this,
                t = i.$element,
                ...
                a = i.$btnFile;
            t.on("change", e.proxy(i.change, i)), a.on("click", function() {
                i.clear(!1), n.focus()
        ...
        loadImage: function(i, t) {
            ...
            a.attr({
                src: w.createObjectURL(i),
                "class": "file-preview-image",
                title: t,
                alt: t,
                onload: function() {
                    w.revokeObjectURL(a.src)
                }
            }), a.width() >= n.$preview.width() && a.attr({
                width: "100%",
                height: "auto"
            });
        ...
        readFiles: function(e) {
            function i(b) {
                ...
                var C = g + "-" + b,
                    ...
                    y = v($.type, $.name),
                    x = ($.size ? $.size : 0) / 1e3;
                if (x = x.toFixed(2), t.maxFileSize > 0 && x > t.maxFileSize) {
                    var I = t.msgSizeTooLarge.replace("{name}", F).replace("{size}", x).replace("{maxSize}", t.maxFileSize);
                    return void(t.isError = t.showError(I, $, C, b))
                }
                a.length > 0 && ("any" == d ? T || y : "text" == d ? y : T) && "undefined" != typeof FileReader ? (s.html(p.replace("{index}", b + 1).replace("{files}", h)), o.addClass("loading"), l.onerror = function(e) {
                    t.errorHandler(e, F)
                }, l.onload = function(e) {
                    var i = "",
                        n = "";
        ...
        change: function(e) {
            ...
            if (t.hideFileIcon(), i = void 0 === e.target.files ? e.target && e.target.value ? [{
                ...
                if (t.maxFileCount > 0 && r > t.maxFileCount) {
                    var d = t.msgFilesTooMany.replace("{m}", t.maxFileCount).replace("{n}", r);
                    return t.isError = t.showError(d, null, null, null), t.$captionContainer.find(".kv-caption-icon").hide(), t.$caption.html(t.msgValidationError), void t.$container.removeClass("file-input-new")
                }
        ...
        overwriteInitial: !0,
        previewTemplate: n,
        previewGenericTemplate: l,
        previewImageTemplate: l,
        previewTextTemplate: o,
        previewOtherTemplate: s,
        captionTemplate: a,
    ...
    var e = function(h, g) {
        ...
        if (this.isRTL) {
            ...
            if (this.bootcssVer == 3) {
                this.picker.find(".prev span, .next span").toggleClass("fa-arrow-left fa-arrow-right")
            } else {
...
! function(a, b) {
    ...
    var n = {
            ...
            closeButton: "<button type='button' class='bootbox-close-button close' data-dismiss='modal' aria-hidden='true'><i class='fa fa-2x'>&times;</i></button>",
    ...
    b.fn = c.Redactor.prototype = {
        ...
        toolbarInit: function(e) {
            ...
            return {
                ...
                unorderedlist: {
                    title: "&bull; " + e.unorderedlist,
                    exec: "insertunorderedlist"
                },
                orderedlist: {
                    title: "1. " + e.orderedlist,
                ...
                table: {
                    ...
                    dropdown: {
                        ...
                        insert_row_above: {
                            title: e.insert_row_above,
                            func: "tableAddRowAbove"
                        },
                        insert_row_below: {
                            title: e.insert_row_below,
                            func: "tableAddRowBelow"
                        },
                        insert_column_left: {
                            title: e.insert_column_left,
                            func: "tableAddColumnLeft"
                        },
                        insert_column_right: {
                            title: e.insert_column_right,
        ...
        buildBindKeyboard: function() {
            ...
            this.$editor.on("blur.redactor", c.proxy(function(f) {
                if (!c(e).hasClass("redactor_toolbar") && c(e).parents(".redactor_toolbar").size() == 0) {
        ...
        buildPlugins: function() {
            ...
            c.each(this.opts.plugins, c.proxy(function(e, f) {
        ...
        iframeAddCss: function(e) {
            e = e || this.opts.css;
            if (this.isString(e)) {
                this.$frame.contents().find("head").append('<link rel="stylesheet" href="' + e + '" />');
            }
            if (c.isArray(e)) {
                c.each(e, c.proxy(function(g, f) {
                    this.iframeAddCss(f);
                }, this));
            }
        },
        ...
        toolbarBuild: function() {
            ...
            c.each(this.opts.buttonsAdd, c.proxy(function(h, j) {
                this.opts.buttons.push(j);
            }, this));
            if (this.opts.toolbar) {
                c.each(this.opts.toolbar.formatting.dropdown, c.proxy(function(h, j) {
        ...
        buttonInactiveAll: function(e) {
            c.each(this.opts.toolbar, c.proxy(function(f) {
                if (f != e) {
        ...
        buttonActiveObserver: function(h, l) {
            ...
            if (this.opts.activeButtonsAdd) {
                c.each(this.opts.activeButtonsAdd, c.proxy(function(e, m) {
                    this.opts.activeButtons.push(m);
                }, this));
                c.extend(this.opts.activeButtonsStates, this.opts.activeButtonsAdd);
            }
            c.each(this.opts.activeButtonsStates, c.proxy(function(e, m) {
        ...
        formatBlocks: function(e) {
            ...
            var f = this.getBlocks();
            this.selectionSave();
            c.each(f, c.proxy(function(g, j) {
                if (j.tagName !== "LI") {
                    var h = c(j).parent();
                    if (e === "p") {
                        if ((j.tagName === "P" && h.size() != 0 && h[0].tagName === "BLOCKQUOTE") || j.tagName === "BLOCKQUOTE") {
                            this.formatQuote();
                            return;
                        } else {
                            if (this.opts.linebreaks) {
        ...
        insertHtml: function(g, j) {
            ...
            if (this.selectall) {
                this.window.setTimeout(c.proxy(function() {
                    if (!this.opts.linebreaks) {
        ...
        pasteClipboardUploadMozilla: function() {
            ...
            c.each(e, c.proxy(function(h, j) {
                ...
                c.post(this.opts.clipboardUploadUrl, {
                    contentType: m,
                    data: l
                }, c.proxy(function(o) {
        ...
        observeLinks: function() {
            ...
            this.$editor.on("click.redactor", c.proxy(function(f) {
                this.linkObserverTooltipClose(f);
            }, this));
            c(document).on("click.redactor", c.proxy(function(f) {
                this.linkObserverTooltipClose(f);
            }, this));
        },
        ...
        linkObserver: function(h) {
            ...
            var l = c('<a href="' + j.attr("href") + '" target="_blank">' + f + "</a>").on("click", c.proxy(function(q) {
        ...
        getBlocks: function(f) {
            ...
            c.each(f, c.proxy(function(h, j) {
                if (this.opts.iframe === false && c(j).parents("div.redactor_editor").size() == 0) {
                    return false;
                }
        ...
        getNodes: function(g, e) {
            ...
            c.each(f, c.proxy(function(n, o) {
                if (this.opts.iframe === false && c(o).parents("div.redactor_editor").size() == 0) {
                    return false;
                }
                if (typeof e === "undefined") {
        ...
        selectionRemoveMarkers: function(e) {
            if (!this.opts.rangy) {
                c.each(this.$editor.find("span.redactor-selection-marker"), function() {
                    var f = c.trim(c(this).html().replace(/[^\u0000-\u1C7F]/g, ""));
                    if (f == "") {
                        c(this).remove();
                    } else {
        ...
        tableDeleteColumn: function() {
            ...
            g.find("tr").each(c.proxy(function(h, j) {
                var l = f - 1 < 0 ? f + 1 : f - 1;
                if (h === 0) {
                    c(j).find("td").eq(l).prepend('<span id="selection-marker-1">' + this.opts.invisibleSpace + "</span>");
                }
        ...
        tableAddColumn: function(h) {
            ...
            var e = c(this.getParent()).closest("td");
            j.find("td").each(c.proxy(function(l, m) {
                if (c(m)[0] === e[0]) {
                    f = l;
                }
            }, this));
        ...
        imageEdit: function(g) {
            ...
            var h = c.proxy(function() {
                ...
                c("#redactor_image_delete_btn").click(c.proxy(function() {
                    this.imageRemove(e);
                }, this));
                c("#redactorSaveBtn").click(c.proxy(function() {
                    this.imageSave(e);
                }, this));
            }, this);
        ...
        imageResizeHide: function(g) {
            if (g !== false && c(g.target).parent().size() != 0 && c(g.target).parent()[0].id === "redactor-image-box") {
                return false;
            }
        ...
        imageResize: function(f) {
            var e = c(f);
            e.on("mousedown", c.proxy(function() {
                this.imageResizeHide(false);
            }, this));
        ...
        imageResizeControls: function(f) {
            ...
            this.imageEditter.on("click", c.proxy(function() {
                this.imageEdit(f);
            }, this));
        ...
        imageThumbClick: function(h) {
            ...
            if (this.opts.paragraphy && c(g).closest("li").size() == 0) {
                f = "<p>" + f + "</p>";
            }
        ...
        s3uploadFile: function(e) {
            this.s3executeOnSignedUrl(e, c.proxy(function(f) {
        ...
        draguploadInit: function(f, e) {
            this.draguploadOptions = c.extend({
                url: false,
                success: false,
                error: false,
                preview: false,
            ...
            this.dropareabox.on("dragover", c.proxy(function() {
                return this.draguploadOndrag();
            }, this));
            this.dropareabox.on("dragleave", c.proxy(function() {
        ...
        browser: function(f) {
            ...
            var e = /(opr)[\/]([\w.]+)/.exec(g) || /(chrome)[ \/]([\w.]+)/.exec(g) || /(webkit)[ \/]([\w.]+).*(safari)[ \/]([\w.]+)/.exec(g) || /(webkit)[ \/]([\w.]+)/.exec(g) || /(opera)(?:.*version|)[ \/]([\w.]+)/.exec(g) || /(msie) ([\w.]+)/.exec(g) || g.indexOf("trident") >= 0 && /(rv)(?::| )([\w.]+)/.exec(g) || g.indexOf("compatible") < 0 && /(mozilla)(?:.*? rv:([\w.]+)|)/.exec(g) || [];
            if (f == "version") {
                return e[2];
            }
            if (f == "webkit") {
