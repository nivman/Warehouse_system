        ...
        <div class="col-lg-12">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover table-striped print-table order-table">
                    ...
                    <tr>
                        ...
                        <td colspan="<?= $tcol; ?>" style="text-align:left;"><?= lang("total"); ?> (<?= $default_currency->code; ?>)                        </td>
                    ...
                    if ($inv->order_discount != 0) {
                        echo '<tr>
                        <td style="text-align:right;">'.($inv->order_discount_id ? '<small>('.$inv->order_discount_id.')</small> ' : '') . $this->sma->formatMoney($inv->order_discount) . '</td>
                        <td colspan="' . $col . '" style="text-align:left;">' . lang("order_discount") . ' (' . $default_currency->code . ')</td>
                    ...
                    if ($Settings->tax2 && $inv->order_tax != 0) {
                        ...
                        <td colspan="' . $col . '" style="text-align:left;">' . lang("order_tax") . ' (' . $default_currency->code . ')</td>
                    ...
                    if ($inv->shipping != 0) {
                        ...
                        <td colspan="' . $col . '" style="text-align:left;">' . lang("shipping") . ' (' . $default_currency->code . ')</td>
                    ...
                    <tr>
                        ...
                        <td colspan="<?= $col; ?>" style="text-align:left; font-weight:bold;"><?= lang("total_amount"); ?>(<?= $default_currency->code; ?>) </td>
            ...
            <div class="row">
                ...
                <div class="col-xs-4  pull-left">
                    <p style="text-align:right;"> <?= $biller->company != '-' ? $biller->company : $biller->name; ?> : <?= lang("seller"); ?></p>
                ...
                <div class="col-xs-4  pull-right">
                    <p style="text-align:right;"><?= $customer->company ? $customer->company : $customer->name; ?> : <?= lang("customer"); ?> </p>
