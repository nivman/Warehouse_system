            ...
            <div class="col-lg-12">
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        ...
                        <?php
                        $opts = array('standard' => lang('standard'), 'combo' => lang('combo'));
                ...
                <div class="col-md-6 col-md-offset-1">
                    ...
                    <div class="combo" style="display:none;">
                        ...
                        <div class="form-group">
                            ...
                            <?php echo form_input('add_item', '', 'class="form-control tip" id="add_item" data-placement="top" data-trigger="focus" data-bv-notEmpty-message="' . lang('please_add_items_below') . '" placeholder="' . $this->lang->line("add_item") . '"'); ?>
                        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#type').change(function () {
            ...
            if (t !== 'standard') {
                $('.standard').slideUp();
                var removeAsterisk =  $('#cost').prev().text().replace("*","");
                var setText =  $('#cost').prev().text(removeAsterisk);
                ...
                var addAsterisk =  $('#cost').prev().text()+" *";
                var setText =  $('#cost').prev().text(addAsterisk);
