                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="input-group-addon no-print"
                                                     style="padding: 2px 8px; border-left: 0;">
                                                    <a href="javascript:void(0)" id="customer-eraser" class="external">
                                                        <i class="fa fa-eraser" id="addIcon"
                                                           style="font-size: 1.2em;"></i>
                                                    </a>
                                                </div>
                                                <div class="input-group-addon no-print"
                                                ...
                                                <?php if ($Owner || $Admin || $GP['customers-add']) { ?>
                                                    <div class="input-group-addon no-print" style="padding: 2px 8px;">
                                                        <a href="<?= site_url('customers/add'); ?>" id="add-customer"
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#customer-eraser").click(function () {
            $("#select2-chosen-11").empty();
