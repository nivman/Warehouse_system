...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-calendar"></i><?= lang('daily_purchases') . ' - ' . ($sel_warehouse ? $sel_warehouse->name : lang('all_warehouses')) . ''; ?>
        </h2>
                ...
                <?php if (!empty($warehouses) && !$this->session->userdata('warehouse_id')) { ?>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                            <li><a href="<?= site_url('reports/daily_purchases/0/' . $year . '/' . $month) ?>"><i
