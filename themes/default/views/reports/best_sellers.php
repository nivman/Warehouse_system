...
<script type="text/javascript">
    ...
    $(function () {
        Highcharts.getOptions().colors = Highcharts.map(Highcharts.getOptions().colors, function (color) {
            return {
                linearGradient: {cx: 0.5, cy: 0.3, r: 0.7,y:-180},
                stops: [[0, '#79CD79'], [1, '#79CD79']]
            };
        });
        <?php if ($m2bs) { ?>
        $('#m2bschart').highcharts({
            ...
            xAxis: {type: 'category', labels: {reserveSpace: false,x:10,y:-5,rotation: -90, style: {fontSize: '13px',color:'black'}}},
        ...
        $('#m1bschart').highcharts({
            ...
            tooltip: {
                ...
                useHTML: true, borderWidth: 0, shadow: true, valueDecimals: site.settings.decimals,
                style: {fontSize: '14px', padding: '0', color: 'black'}
            },
            series: [{
                name: '<?=lang('sold');?>',
...
<div class="box">
    <div class="box-header">
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#"><i class="icon fa fa-building-o tip" data-placement="right" title="<?= lang("warehouses") ?>"></i></a>
