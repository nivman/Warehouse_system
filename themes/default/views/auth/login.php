...
<body style="direction: rtl;" class="login-page">
<noscript>
    ...
    <div id="login">
        <div class="text-center ">
            <?php if ($Settings->logo2) {
                echo '<img class="logo-login" src="' . base_url('assets/uploads/logos/' . $Settings->logo2) . '" alt="' . $Settings->site_name . '" style="margin-bottom:10px;" />';
            } ?>
        </div>
        <div class=" container">
            ...
            <div class="login-form-div">
                <div class="login-content">
                    ...
                    <div class="form-action col-sm-12">
                        ...
                        <button type="submit" class="btn btn-success pull-right login-button"><?= lang('login') ?> &nbsp;</button>
                    </div>
                    <?php echo form_close(); ?>
                    <div class="clearfix"></div>
                </div>
                <div class="checkbox pull-left remember-custom-checkbox">
